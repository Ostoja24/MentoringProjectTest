...
public class BaseTest {
    ...
    public Object explicitwaittest(WebDriver driver, String path) {
        return new WebDriverWait(driver, Duration.ofSeconds(implicitWaitValue)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(path)));
    }
}
